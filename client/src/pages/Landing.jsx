        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            <p className="text-[10px] text-slate-300 uppercase tracking-[0.4em] font-sans font-bold">
              Republic of the Philippines <span className="mx-2 text-slate-600">|</span> Commission on Higher Education
            </p>
          </div>
          <div className="hidden md:flex items-center gap-4 text-[9px] text-[#C5A059] uppercase tracking-widest font-sans font-bold">
            <span className="flex items-center gap-1"><Lock size={10}/> Secure Terminal</span>
            <span className="flex items-center gap-1"><History size={10}/> v2026.0.4</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-10 py-24 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-7xl font-black text-[#0C1B33] leading-[0.95] tracking-tighter italic lg:not-italic">
              Digital  <br />
              <span className="text-[#C5A059] underline decoration-slate-200 underline-offset-8">Transmittal</span> <br />
            ...
            <p className="mt-10 text-xl text-slate-600 leading-relaxed max-w-lg font-sans border-l-4 border-[#C5A059] pl-6">
              The secure platform for electronic transmittal creation, document verification, 
              and real-time archival tracking of official records.
            </p>
            ...
            <div className="mt-12 flex flex-wrap gap-5 font-sans">
              ...
              >
                Officer Login <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </Link>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white border border-slate-300 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] overflow-hidden">
              ...
              <div className="p-1 grid grid-cols-2 gap-1 bg-slate-100">
                <StatCard label="Daily Volume" value="1,245" sub="Transmissions" />
                <StatCard label="Pending Action" value="23" sub="Priority 1" highlight />
                <StatCard label="Successful Releases" value="980" sub="Verified 100%" />
                <StatCard label="Digital Archives" value="24.2k" sub="Total Records" />
              </div>
              ...
              <div className="p-8 bg-white text-center">
                <p className="text-[11px] font-sans text-slate-400 leading-loose uppercase tracking-tighter">
                  ...
                  <strong className="text-slate-600">Data Privacy Act of 2012 (RA 10173)</strong>
                </p>
              </div>
            </div>
          </div>
...
function StatCard({ label, value, sub, highlight }) {
  return (
    <div className="bg-white p-10 flex flex-col items-center text-center">
      ...
      <h2 className={`text-5xl font-black mb-1 ${highlight ? 'text-[#CE1126]' : 'text-[#0C1B33]'}`}>
        {value}
      </h2>
